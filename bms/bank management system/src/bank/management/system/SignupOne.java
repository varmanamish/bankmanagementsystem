...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        male.setFont(new Font("Raleway", Font.ITALIC, 12));
        male.setBackground(Color.white);
        add(male);
        
        female = new JRadioButton("Female");
        female.setBounds(380, 290, 100, 30);
        female.setFont(new Font("Raleway", Font.ITALIC, 12));
        ...
        married.setFont(new Font("Raleway", Font.ITALIC, 12));
        married.setBackground(Color.white);
        add(married);
        
        unmarried = new JRadioButton("Un-married");
        unmarried.setBounds(380, 390, 100, 30);
        unmarried.setFont(new Font("Raleway", Font.ITALIC, 12));
        unmarried.setBackground(Color.white);
        add(unmarried);
        
        other = new JRadioButton("Other");
        other.setBounds(480, 390, 60, 30);
        other.setFont(new Font("Raleway", Font.ITALIC, 12));
